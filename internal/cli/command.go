	...
	return Command{
		...
		Children: []Command{
			...
			{Name: "lookaside", Summary: "Configure and maintain content-addressed objects", Children: []Command{
				{Name: "configure", Summary: "Configure cache, read mirrors, and publication", Usage: "waldo lookaside configure [--cache <directory> | --default-cache] [--mirror <base-url>] [--publish <s3-url>] [--publish-region <region>] [--publish-endpoint <url>] [--publish-path-style] [--upload-workers <1..32>] [--keep-local | --no-keep-local] [--clear-publish] [--json]", Handler: runLookasideConfigure},
