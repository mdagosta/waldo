...
var modelPresets = []Preset{
	...
	preset("300m", 2048, 100277, 1024, 2816, 24, 16, 4, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	preset("1b", 4096, 100277, 2048, 8192, 16, 32, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	preset("3b", 4096, 100277, 3072, 8192, 28, 24, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	preset("7b", 4096, 100277, 4096, 14336, 32, 32, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	// Larger rungs remain useful for planning even when the current local
	// backend cannot execute them.
	preset("13b", 4096, 100277, 5120, 16384, 40, 40, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	preset("34b", 4096, 100277, 8192, 22016, 48, 64, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
	preset("70b", 4096, 100277, 8192, 28672, 80, 64, 8, "tiktoken/cl100k_base", "tiktoken-cl100k-base"),
}
