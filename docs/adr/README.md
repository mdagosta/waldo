...
- [0014: Execute external fetchers only through explicit ingest recipe (superseded)](0014-explicit-ingest-recipe.md)
...
- [0038: Preserve recipe-relative paths for file records (superseded)](0038-preserve-recipe-source-paths.md)
- [0039: Preserve source evidence in ingest recipes (superseded)](0039-recipe-source-evidence.md)
